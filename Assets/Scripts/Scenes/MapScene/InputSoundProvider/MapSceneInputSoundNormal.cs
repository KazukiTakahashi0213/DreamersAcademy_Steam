...
public class MapSceneInputSoundNormal : BMapSceneInputSound {
	...
	public override void SelectMenu() {
		AudioClip data = ResourcesSoundsLoader.GetInstance().GetSounds(SoundsPathSupervisor.GetInstance().GetPathSelect3());
		AllSceneManager.GetInstance().GetPublicAudioParts().GetSEAudioSource().PlayOneShot(data);
	}
}
